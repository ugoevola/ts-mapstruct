...
export const apply = (
  ...
  Reflect.getOwnMetadata(metadataKey, consumer)
    ...
    ?.map((applier: FunctionDescriptor) => computeArguments(metadataKey, consumer, applier, sourceObjects, targetedObject, sourceArgsDescriptors))
...
const isReturnedType = (targetedObject: any, consumer: any, functionName: string) => {
