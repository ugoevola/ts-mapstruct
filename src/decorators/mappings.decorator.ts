...
export const Mappings = (...options: MappingOptions[]) => (
  ...
  let targetedObject = plainToClass(Reflect.getPrototypeOf(descriptor.value.call()).constructor as ClassConstructor<any>, {})
...
const retrieveMappingTarget = (consumer: any, property: string, args: any[], targetedObject: any): any => {
  const index = Reflect.getOwnMetadata(MAPPING_TARGET, consumer, property)
  ...
  return plainToClass(
    ...
    args[index],
    { enableImplicitConversion: true, strategy: 'exposeAll' })
}
